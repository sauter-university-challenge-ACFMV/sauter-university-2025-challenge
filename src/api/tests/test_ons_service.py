...
def test_process_reservoir_data_success_filters_and_downloads(monkeypatch: Any) -> None:
    ...
    resources = [
        {
            "format": "PARQUET",
            "url": "https://cdn/ear_2022.parquet",
            "name": "ear 2022",
        },
        {
            "format": "PARQUET",
            "url": "https://cdn/ear_2023.parquet",
            "name": "ear 2023",
        },
        {"format": "CSV", "url": "https://cdn/ear_2024.csv", "name": "ear 2024"},
        {
            "format": "PARQUET",
            "url": "https://cdn/ear_2021.parquet",
            "name": "ear 2021",
        },
    ]
...
def test_build_gcs_path_uses_year_partition(monkeypatch: Any) -> None:
    ...
    service = OnsService()
    p = service._build_gcs_path(
        "file_2020.parquet", resource_year=2020, package_name="pkg"
    )
